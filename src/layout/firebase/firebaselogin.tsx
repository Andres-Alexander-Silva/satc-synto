            ...
            <div className="mt-7">
              <nav className="!block px-6" aria-label="Tabs">
                <div className="flex justify-center space-x-2">
                  <button
                    type="button"
                    className="hs-tooltip-toggle hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-gray-500 rounded-sm hover:text-primary  dark:text-white/70 dark:hover:text-white active"
                  ...
                  >
                    <img
                      src={ALLImages("png8")}
                      className="avatar w-6 h-6 rounded-full ring-0"
                      alt="user-img"
                    />
                    <span
                  ...
                  <button
                    type="button"
                    className="hs-tooltip-toggle hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-gray-500 rounded-sm hover:text-primary  dark:text-white/70 dark:hover:text-white"
