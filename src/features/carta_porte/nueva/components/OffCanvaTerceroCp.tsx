...
const OffCanvaTerceroCp = () => {
  ...
  return (
    <div
      id="hs-overlay-right"
      className="hs-overlay hidden ti-offcanvas ti-offcanvas-right md:!max-w-2xl md:w-full"
      tabIndex={-1}
    >
      <div className="ti-offcanvas-header">
        <h3 className="ti-offcanvas-title">Crear tercero</h3>
        <button
          type="button"
      ...
      <form onSubmit={methodsTerceros.handleSubmit(onSubmit)}>
        <div className="ti-offcanvas-body grid grid-cols-2 gap-2">
          <Controller
            name="tipo_documento"
                ...
                {methodsTerceros.formState.errors?.numero_identificacion ? (
                  methodsTerceros.formState.errors.numero_identificacion
                    ...
                    <span className="text-xs text-red-500">
                      ...
                      .type === "pattern" ? (
                    <span className="text-xs text-red-500">Solo números</span>
                  ) : methodsTerceros.formState.errors.numero_identificacion
                      .type === "maxLength" ? (
                    <span className="text-xs text-red-500">
                      {methodsTerceros.watch("tipo_documento")?.value === 17
          ...
          <Controller
            ...
            render={({ field }) => (
              <div className="mt-2">
                ...
                />
                {methodsTerceros.formState.errors.digito_verificacion ? (
                  methodsTerceros.formState.errors.digito_verificacion.type ===
                  "required" ? (
                    <span className="text-xs text-red-500">
                      Campo requerido
                    </span>
          ...
          <Controller
            ...
            render={({ field }) => (
              <div className="mt-2">
                <label
                  className={`block text-sm mb-2 dark:text-white ${
                    methodsTerceros.formState.errors.pais ? "text-red-500" : ""
                  }`}
                >
                  Pais
                </label>
                ...
                {methodsTerceros.formState.errors.pais ? (
                  methodsTerceros.formState.errors.pais.type === "required" ? (
                    <span className="text-xs text-red-500">
                      Campo requerido
                    </span>
                  ) : (
...
export default OffCanvaTerceroCp;
