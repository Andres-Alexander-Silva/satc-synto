...
import { useModalTipoDocumento } from "@/features/configuracion/tipo_documentos/hooks";
...
const ModalTipoDocumento = () => {
  ...
  } = useModalTipoDocumento();

  return (
    <div
      id="hs-focus-management-modal-tipo-documento"
        ...
        <div className="ti-modal-content">
          <div className="ti-modal-header">
            <h3 className="ti-modal-title">
              {currentTipoDocumento.id ? "Editar" : "Agregar"} tipo de documento
            </h3>
            <button
              type="button"
          ...
          <form onSubmit={methodsTipoDocumento.handleSubmit(onSubmit)}>
            <div className="ti-modal-body">
              <Controller
                name="sigla"
                control={methodsTipoDocumento.control}
                rules={{ required: true }}
                defaultValue=""
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsTipoDocumento.formState.errors.sigla
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsTipoDocumento.formState.errors.sigla ? (
                      methodsTipoDocumento.formState.errors.sigla.type ===
                      "required" ? (
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsTipoDocumento.formState.errors.descripcion
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsTipoDocumento.formState.errors.descripcion ? (
                      methodsTipoDocumento.formState.errors.descripcion.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
