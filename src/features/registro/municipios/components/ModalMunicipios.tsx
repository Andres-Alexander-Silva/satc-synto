import { useModalMunicipios } from "@/features/registro/municipios/hooks";
...
const ModalMunicipios = () => {
  ...
  const formatDtos = departamentos.map((dpto) => {
    return { value: dpto.id, label: dpto.nombre };
  });

  return (
    <div
      id="hs-focus-management-modal-mun"
        ...
        <div className="ti-modal-content">
          <div className="ti-modal-header">
            <h3 className="ti-modal-title">
              {currentMunicipios.id ? "Editar" : "Agregar"} municipio
            </h3>
            <button
              type="button"
          ...
          <form onSubmit={methodsMunicipios.handleSubmit(onSubmit)}>
            <div className="ti-modal-body">
              <Controller
                name="codigo"
                control={methodsMunicipios.control}
                rules={{ required: true }}
                defaultValue=""
                render={({ field }) => (
                  <div>
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsMunicipios.formState.errors.codigo
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsMunicipios.formState.errors.codigo ? (
                      methodsMunicipios.formState.errors.codigo.type ===
                      "required" ? (
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsMunicipios.formState.errors.nombre
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsMunicipios.formState.errors.nombre ? (
                      methodsMunicipios.formState.errors.nombre.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsMunicipios.formState.errors.departamento
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsMunicipios.formState.errors.departamento ? (
                      methodsMunicipios.formState.errors.departamento.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
