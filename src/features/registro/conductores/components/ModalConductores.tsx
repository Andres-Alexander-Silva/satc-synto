...
import { useModalConductores } from "@/features/registro/conductores/hooks";

const ModalConductores = () => {
  const {
    currentConductores,
    handleClose,
    loading,
  ...
  return (
    <div
      id="hs-focus-management-modal-conductor"
        ...
        <div className="ti-modal-content">
          <div className="ti-modal-header">
            <h3 className="ti-modal-title">
              {currentConductores.id ? "Editar" : "Agregar"} conductor
            </h3>
            <button
              type="button"
          ...
          <form onSubmit={methodsConductores.handleSubmit(onSubmit)}>
            <div className="ti-modal-body grid grid-cols-2 gap-2">
              <Controller
                name="tipo_documento"
                control={methodsConductores.control}
                rules={{ required: true }}
                defaultValue=""
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsConductores.formState.errors.tipo_documento
                          ? "text-red-500"
                          : ""
                      }`}
                    >
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsConductores.formState.errors.numero_documento
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    <input
                      {...field}
                      type="text"
                      onBlur={() => findDocumentoConductor(field.value)}
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsConductores.formState.errors.nombre
                          ? "text-red-500"
                          : ""
                      }`}
                    >
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsConductores.formState.errors.apellido
                          ? "text-red-500"
                          : ""
                      }`}
                    >
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsConductores.formState.errors.nacionalidad
                          ? "text-red-500"
                          : ""
                      }`}
                    >
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsConductores.formState.errors.celular
                          ? "text-red-500"
                          : ""
                      }`}
                    >
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsConductores.formState.errors.libreta
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    <input
                      ...
                      placeholder="Ingrese la libreta"
                      autoFocus
                    />
                    {methodsConductores.formState.errors.libreta ? (
                      <span className="text-xs text-red-500">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsConductores.formState.errors.licencia
                          ? "text-red-500"
                          : ""
                      }`}
                    >
