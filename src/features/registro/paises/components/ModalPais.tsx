import { useModalPais } from "@/features/registro/paises/hooks";
import { Controller } from "react-hook-form";
import { Loader } from "@/components";

const ModalPais = () => {
  const { methodsPais, onSubmit, loading, handleClose, currentPais } =
    useModalPais();

  return (
    <div
      id="hs-focus-management-modal-pais"
        ...
        <div className="ti-modal-content">
          <div className="ti-modal-header">
            <h3 className="ti-modal-title">
              {currentPais.id ? "Editar" : "Agregar"} pais
            </h3>
            <button
              type="button"
          ...
          <form onSubmit={methodsPais.handleSubmit(onSubmit)}>
            <div className="ti-modal-body">
              <Controller
                name="nombre"
                control={methodsPais.control}
                  ...
                  <div>
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsPais.formState.errors.nombre
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsPais.formState.errors.nombre ? (
                      methodsPais.formState.errors.nombre.type ===
                      "required" ? (
            ...
            <div className="ti-modal-footer">
              ...
              <button type="submit" className="ti-btn ti-btn-primary">
                {loading ? <Loader /> : currentPais.id ? "Actualizar" : "Crear"}
              </button>
            </div>
          </form>
        </div>
