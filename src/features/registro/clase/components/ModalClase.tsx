...
import { useModalClase } from "@/features/registro/clase/hooks";
import { Loader } from "@/components";

const ModalClase = () => {
  const { currentClase, handleClose, loading, methodsClase, onSubmit } =
    useModalClase();

  return (
    <div
      id="hs-focus-management-modal-clase"
        ...
        <div className="ti-modal-content">
          <div className="ti-modal-header">
            <h3 className="ti-modal-title">
              {currentClase.id ? "Editar" : "Agregar"} clase
            </h3>
            <button
              type="button"
          ...
          <form onSubmit={methodsClase.handleSubmit(onSubmit)}>
            <div className="ti-modal-body">
              <Controller
                name="nombre"
                control={methodsClase.control}
                rules={{
                  required: true,
                }}
                defaultValue=""
                  ...
                  <div>
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsClase.formState.errors.nombre
                          ? "text-red-500"
                          : ""
                      }`}
                    >
