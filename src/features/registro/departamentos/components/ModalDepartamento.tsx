import { useModalDepartamentos } from "@/features/registro/departamentos/hooks";
...
const ModalDepartamento = () => {
  const {
    ...
    paises,
  } = useModalDepartamentos();

  const formatPaises = paises.map((pais) => {
    return { value: pais.id, label: pais.nombre };
  });

  return (
    <div
      id="hs-focus-management-modal-dpto"
        ...
        <div className="ti-modal-content">
          <div className="ti-modal-header">
            <h3 className="ti-modal-title">
              {currentDepartamentos.id ? "Editar" : "Agregar"} departamento
            </h3>
            <button
              type="button"
          ...
          <form onSubmit={methodsDepartamentos.handleSubmit(onSubmit)}>
            <div className="ti-modal-body">
            <Controller
                name="codigo"
                control={methodsDepartamentos.control}
                  ...
                  <div>
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsDepartamentos.formState.errors.codigo
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsDepartamentos.formState.errors.codigo ? (
                      methodsDepartamentos.formState.errors.codigo.type ===
                      "required" ? (
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div>
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsDepartamentos.formState.errors.nombre
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsDepartamentos.formState.errors.nombre ? (
                      methodsDepartamentos.formState.errors.nombre.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsDepartamentos.formState.errors.pais
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsDepartamentos.formState.errors.pais ? (
                      methodsDepartamentos.formState.errors.pais.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
