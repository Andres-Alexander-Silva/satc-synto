...
import { useModalMacas } from "@/features/registro/marca/hooks";
import { Loader } from "@/components";

const ModalMarcas = () => {
  const { currentMarcas, handleClose, loading, methodsMarcas, onSubmit } =
    useModalMacas();

  return (
    <div
      id="hs-focus-management-modal-marca"
        ...
        <div className="ti-modal-content">
          <div className="ti-modal-header">
            <h3 className="ti-modal-title">
              {currentMarcas.id ? "Editar" : "Agregar"} marcas
            </h3>
            <button
              type="button"
          ...
          <form onSubmit={methodsMarcas.handleSubmit(onSubmit)}>
            <div className="ti-modal-body">
              <Controller
                name="nombre"
                control={methodsMarcas.control}
                rules={{
                  required: true,
                }}
                defaultValue=""
                  ...
                  <div>
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsMarcas.formState.errors.nombre
                          ? "text-red-500"
                          : ""
                      }`}
                    >
