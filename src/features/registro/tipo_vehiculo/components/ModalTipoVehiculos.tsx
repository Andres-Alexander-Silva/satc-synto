...
import { useModalTipoVehiculos } from "@/features/registro/tipo_vehiculo/hooks";
import { Loader } from "@/components";

const ModalTipoVehiculos = () => {
  const {
    currentTipoVehiculo,
    handleClose,
    loading,
    methodsTipoVehiculo,
    onSubmit,
  } = useModalTipoVehiculos();

  return (
    <div
      id="hs-focus-management-modal-tipo-vehiculo"
        ...
        <div className="ti-modal-content">
          <div className="ti-modal-header">
            <h3 className="ti-modal-title">
              {currentTipoVehiculo.id ? "Editar" : "Agregar"} tipo de vehiculo
            </h3>
            <button
              type="button"
          ...
          <form onSubmit={methodsTipoVehiculo.handleSubmit(onSubmit)}>
            <div className="ti-modal-body">
              <Controller
                name="nombre"
                control={methodsTipoVehiculo.control}
                rules={{
                  required: true,
                }}
                defaultValue=""
                  ...
                  <div>
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsTipoVehiculo.formState.errors.nombre
                          ? "text-red-500"
                          : ""
                      }`}
                    >
...
export default ModalTipoVehiculos;
