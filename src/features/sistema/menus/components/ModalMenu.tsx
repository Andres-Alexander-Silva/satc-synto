import { useModalMenu } from "@/features/sistema/menus/hooks";
import { Controller } from "react-hook-form";
import { Loader } from "@/components";

const ModalMenu = () => {
  const { currentMenu, handleClose, loading, methodsMenu, onSubmit } =
    useModalMenu();

  return (
    <div
      id="hs-focus-management-modal-menu"
        ...
        <div className="ti-modal-content">
          <div className="ti-modal-header">
            <h3 className="ti-modal-title">
              {currentMenu.id ? "Editar" : "Agregar"} menu
            </h3>
            <button
              type="button"
          ...
          <form onSubmit={methodsMenu.handleSubmit(onSubmit)}>
            <div className="ti-modal-body">
              <Controller
                name="nombre"
                control={methodsMenu.control}
                rules={{ required: true }}
                defaultValue=""
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsMenu.formState.errors.nombre
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsMenu.formState.errors.nombre ? (
                      methodsMenu.formState.errors.nombre.type ===
                      "required" ? (
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsMenu.formState.errors.icono ? "text-red-500" : ""
                      }`}
                    >
                      Icono
                    </label>
                    <input
                      type="text"
                      className={`py-2 px-3 block w-full border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 ${
                        methodsMenu.formState.errors.icono
                          ? "focus:border-red-500 focus:red-500 dark:border-red-500 dark:focus:border-red-500 dark:focus:red-500 border-red-500"
                          : ""
                      }`}
                      placeholder="Icono"
                    ...
                    />
                    {methodsMenu.formState.errors.icono ? (
                      methodsMenu.formState.errors.icono.type === "required" ? (
                        <span className="text-xs text-red-500">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsMenu.formState.errors.orden ? "text-red-500" : ""
                      }`}
                    >
                      Orden
                    </label>
                    <input
                      type="text"
                      className={`py-2 px-3 block w-full border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 ${
                        methodsMenu.formState.errors.orden
                          ? "focus:border-red-500 focus:red-500 dark:border-red-500 dark:focus:border-red-500 dark:focus:red-500 border-red-500"
                          : ""
                      }`}
                      placeholder="Orden"
                    ...
                    />
                    {methodsMenu.formState.errors.orden ? (
                      methodsMenu.formState.errors.orden.type === "required" ? (
                        <span className="text-xs text-red-500">
            ...
            <div className="ti-modal-footer">
              ...
              <button type="submit" className="ti-btn ti-btn-primary">
                {loading ? <Loader /> : currentMenu.id ? "Actualizar" : "Crear"}
              </button>
            </div>
          </form>
        </div>
