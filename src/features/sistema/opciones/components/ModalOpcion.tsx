import { useModalOpciones } from "@/features/sistema/opciones/hooks";
...
const ModalOpcion = () => {
  ...
  return (
    <div
      id="hs-focus-management-modal-opcion"
        ...
        <div className="ti-modal-content">
          <div className="ti-modal-header">
            <h3 className="ti-modal-title">
              {currentOpciones.id ? "Editar" : "Agregar"} opcion
            </h3>
            <button
              type="button"
          ...
          <form onSubmit={methodsOpciones.handleSubmit(onSubmit)}>
            <div className="ti-modal-body grid grid-cols-2 gap-2">
              <Controller
                name="nombre"
                control={methodsOpciones.control}
                rules={{ required: true }}
                defaultValue=""
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsOpciones.formState.errors.nombre
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsOpciones.formState.errors.nombre ? (
                      methodsOpciones.formState.errors.nombre.type ===
                      "required" ? (
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsOpciones.formState.errors.icono
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsOpciones.formState.errors.icono ? (
                      methodsOpciones.formState.errors.icono.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsOpciones.formState.errors.url
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsOpciones.formState.errors.url ? (
                      methodsOpciones.formState.errors.url.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsOpciones.formState.errors.estado
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsOpciones.formState.errors.estado ? (
                      methodsOpciones.formState.errors.estado.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsOpciones.formState.errors.orden
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    />
                    {methodsOpciones.formState.errors.orden ? (
                      methodsOpciones.formState.errors.orden.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
                          El orden es requerido
                        </span>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsOpciones.formState.errors.subOpcion
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    <Select
                      {...field}
                      classNamePrefix="react-select"
                      options={dataSubOpcion}
                      placeholder="Sub opcion"
                    />
                    {methodsOpciones.formState.errors.subOpcion ? (
                      methodsOpciones.formState.errors.subOpcion.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
                          La sub opcion es requerida
                        </span>
                      ) : (
                        ""
                      )
              ...
              <Controller
                ...
                render={({ field }) => (
                  <div className="mt-2">
                    <label
                      className={`block text-sm mb-2 dark:text-white ${
                        methodsOpciones.formState.errors.menu
                          ? "text-red-500"
                          : ""
                      }`}
                    >
                    ...
                    <Select
                      ...
                      classNamePrefix="react-select"
                      options={formatMenu}
                      placeholder="Selecciona el menu"
                    />
                    {methodsOpciones.formState.errors.menu ? (
                      methodsOpciones.formState.errors.menu.type ===
                      "required" ? (
                        <span className="text-xs text-red-500">
                          El menu es requerido
                        </span>
                      ) : (
                        ""
                      )
