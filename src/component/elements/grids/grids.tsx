              ...
              <div className="relative">
                <div className="relative rounded-sm overflow-auto">
                  <div className="sm:grid space-y-6 sm:space-y-0 grid-cols-4 gap-4 font-mono text-white text-sm text-center font-bold rounded-sm">
                    <div className="p-4 rounded-sm shadow-lg bg-primary">
                      01
                    </div>
                    <div className="p-4 rounded-sm shadow-lg bg-primary">
                      02
              ...
              <div className="relative">
                <div className="relative rounded-sm overflow-auto">
                  <div className="sm:grid space-y-6 sm:space-y-0 grid-cols-3 gap-4 font-mono text-white text-sm text-center font-bold">
                    ...
                    <div className="p-4 rounded-sm shadow-lg bg-primary col-span-2">
                      04
                    </div>
              ...
              <div className="relative">
                <div className="relative rounded-sm overflow-auto">
                  <div className="sm:grid space-y-6 sm:space-y-0 grid-cols-6 gap-4 font-mono text-white text-sm text-center font-bold">
                    ...
                    <div className="p-4 rounded-sm shadow-lg bg-primary col-start-2 col-span-4">
                      01
                    </div>
                    <div className="p-4 rounded-sm"></div>
                    <div className="p-4 rounded-sm shadow-lg bg-primary col-start-1 col-end-3">
                      02
                    </div>
                    <div className="p-4 rounded-sm"></div>
                    <div className="p-4 rounded-sm"></div>
                    <div className="p-4 rounded-sm shadow-lg bg-primary col-end-7 col-span-2">
                      03
                    </div>
                    <div className="p-4 rounded-sm shadow-lg bg-primary col-start-1 col-end-7">
                      04
                    </div>
                  </div>
                </div>
              ...
              <div className="relative">
                <div className="relative rounded-sm overflow-auto">
                  <div className="sm:grid space-y-6 sm:space-y-0 grid-rows-3 grid-flow-col gap-4 font-mono text-white text-sm text-center font-bold rounded-sm">
                    <div className="p-4 rounded-sm shadow-lg bg-primary sm:grid space-y-6 sm:space-y-0 place-content-center row-span-3">
                      01
                    </div>
                    <div className="p-4 rounded-sm bg-primary sm:grid space-y-6 sm:space-y-0 place-content-center col-span-2">
                      02
                    </div>
                    <div className="p-4 rounded-sm shadow-lg bg-primary sm:grid space-y-6 sm:space-y-0 place-content-center row-span-2 col-span-2">
                      03
                    </div>
                  </div>
                </div>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="relative">
                <div className="relative rounded-sm overflow-auto">
                  <div className="sm:grid space-y-6 sm:space-y-0 grid-rows-3 grid-flow-col gap-4 font-mono text-white text-sm text-center font-bold rounded-sm">
                    <div className="p-4 sm:p-12 rounded-sm shadow-lg bg-primary sm:grid space-y-6 sm:space-y-0 place-content-center row-start-2 row-span-2">
                      01
                    </div>
                    <div className="p-4 sm:p-12 rounded-sm shadow-lg bg-primary sm:grid space-y-6 sm:space-y-0 place-content-center row-end-3 row-span-2">
                      02
                    </div>
                    <div className="p-4 sm:p-12 rounded-sm shadow-lg bg-primary sm:grid space-y-6 sm:space-y-0 place-content-center row-start-1 row-end-4">
                      03
                    </div>
                  </div>
                </div>
              ...
              <div className="relative">
                <div className="relative rounded-sm overflow-auto">
                  <div className="sm:grid space-y-6 sm:space-y-0 grid-cols-3 grid-rows-3 grid-flow-row-dense gap-4 font-mono text-white text-sm text-center font-bold rounded-sm">
                    <div className="p-4 col-span-2 rounded-sm bg-primary">
                      01
                    </div>
                    <div className="p-4 col-span-2 rounded-sm bg-primary">
                      02
              ...
              <div className="relative">
                <div className="relative rounded-sm overflow-auto">
                  <div className="sm:grid space-y-6 sm:space-y-0 grid-cols-12 gap-4 font-mono text-white text-sm text-center font-bold rounded-sm">
                    <div className="col-span-12 sm:col-span-4 p-4 rounded-sm shadow-lg bg-primary">
                      Column
                    </div>
                    <div className="col-span-12 sm:col-span-4 p-4 rounded-sm shadow-lg bg-primary">
                      Column
