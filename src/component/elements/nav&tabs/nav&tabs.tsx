                            ...
                            <div className= "flex">
                              <div className= "ltr:border-r rtl:border-l border-gray-200 dark:border-white/10">
                                <nav className= "flex flex-col space-y-2 whitespace-nowrap" aria-label="Tabs" data-hs-tabs-vertical="true">
                                  <button type="button" className= "hs-tab-active:bg-white ltr:hs-tab-active:border-r rtl:hs-tab-active:border-l hs-tab-active:text-primary dark:hs-tab-active:bg-transparent ltr:dark:hs-tab-active:border-r rtl:dark:hs-tab-active:border-l dark:hs-tab-active:text-primary -mr-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500  ltr:rounded-l-sm rtl:rounded-r-sm hover:text-gray-700 dark:bg-black/20 dark:border-white/10 dark:text-white/70 dark:hover:text-gray-300 active" id="hs-tab-js-vertical-item-1" data-hs-tab="#hs-tab-js-vertical-1" aria-controls="hs-tab-js-vertical-1">
                                    Tab 1
                                  </button>
