							...
							<div className="p-4" id="buy-style-1">
								<div className="mb-4">
									<div className="sm:flex rounded-sm">
										...
										<div className="sm:inline-flex mt-1 sm:mt-0 items-center min-w-fit  sm:ltr:rounded-r-sm sm:ltr:rounded-l-none sm:rtl:rounded-l-sm sm:rtl:rounded-r-none  border sm:ltr:border-l-0 sm:rtl:border-r-0 border-gray-200  dark:bg-black/20 dark:border-white/10">
