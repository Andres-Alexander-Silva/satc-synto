								...
								<div className="box-body">
									...
									<div className="flex justify-between items-center">
										...
										<div className="ltr:ml-1 rtl:mr-1 min-w-fit">
											<Link to="#" className="ltr:mr-2 rtl:ml-2 opacity-60 text-sm text-white inline-flex"><i
												className="ri-attachment-2 ltr:mr-1 rtl:ml-1 text-sm inline-flex"></i>3</Link>
											<Link to="#" className="opacity-60 text-sm text-white inline-flex"><i
												className="ri-chat-3-line ltr:mr-1 rtl:ml-1 text-sm inline-flex"></i>29</Link>
										</div>
									</div>
								</div>
							</div>
