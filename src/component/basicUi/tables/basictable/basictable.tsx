            ...
            <div className="box-body p-0">
              <div className="overflow-auto">
                <table className="ti-custom-table ti-custom-table-head">
                  ...
                  <tbody>
                    <tr>
                      <td className="bg-primary font-medium dark:!text-white !text-white">
                        John Brown
                      </td>
                      <td>45</td>
                      <td>New York No. 1 Lake Park</td>
                    ...
                    <tr>
                      <td className="font-medium">Jim Green</td>
                      <td className="bg-orange-500 dark:!text-white !text-white">
                        27
                      </td>
                      <td>London No. 1 Lake Park</td>
                      <td className="text-end font-medium">
                    ...
                    <tr>
                      <td className="bg-red-500 font-medium dark:!text-white !text-white">
                        Joe Black
                      </td>
                      <td className="bg-primary dark:!text-white !text-white">
                        31
                      </td>
                      <td className="bg-primary dark:!text-white !text-white">
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            ...
            <div className="box-body p-0">
              <div className="overflow-auto">
                <table className="ti-custom-table ti-custom-table-head">
                  <caption className="py-2 px-4 text-start text-sm text-gray-600 dark:text-white/70">
                    List of users
                  </caption>
                  <thead>
                    <tr>
              ...
              <div className="table-bordered rounded-md ti-custom-table-head">
                <div className="py-2 px-3">
                  <div className="relative max-w-xs">
                    <label htmlFor="hs-table-search1" className="sr-only">
                      Search
                    </label>
                    <input
                      type="text"
                    ...
                    <thead className="bg-gray-50 dark:bg-black/20">
                      <tr>
                        <th scope="col" className="py-2 px-3 ltr:pr-0 rtl:pl-0">
                          <div className="flex items-center h-5">
                            <input
                              id="hs-table-search-checkbox-all1"
                              type="checkbox"
                              className="ti-form-checkbox"
                            />
                            <label
                              htmlFor="hs-table-search-checkbox-all1"
                              className="sr-only"
                            >
                              Checkbox
                            </label>
                    ...
                    <tbody className="">
                      ...
                      <tr>
                        <td className="py-3 ltr:pl-4 rtl:pr-4">
                          <div className="flex items-center justify-center h-5">
                            ...
                            />
                            <label
                              htmlFor="hs-table-search-checkbox-2"
                              className="sr-only"
                            >
                              Checkbox
                            </label>
                      ...
                      <tr>
                        <td className="py-3 ltr:pl-4 rtl:pr-4">
                          <div className="flex items-center justify-center h-5">
                            <input
                              id="hs-table-search-checkbox-3"
                              type="checkbox"
                              className="ti-form-checkbox"
                            />
                            <label
                              htmlFor="hs-table-search-checkbox-3"
                              className="sr-only"
                            >
                              Checkbox
                            </label>
                      ...
                      <tr>
                        <td className="py-3 ltr:pl-4 rtl:pr-4">
                          <div className="flex items-center justify-center h-5">
                            <input
                              id="hs-table-search-checkbox-4"
                              type="checkbox"
                              className="ti-form-checkbox"
                            />
                            <label
                              htmlFor="hs-table-search-checkbox-4"
                              className="sr-only"
                            >
                              Checkbox
                            </label>
                      ...
                      <tr>
                        <td className="py-3 ltr:pl-4 rtl:pr-4">
                          <div className="flex items-center justify-center h-5">
                            <input
                              id="hs-table-search-checkbox-5"
                              type="checkbox"
                              className="ti-form-checkbox"
                            />
                            <label
                              htmlFor="hs-table-search-checkbox-5"
                              className="sr-only"
                            >
                              Checkbox
                            </label>
              ...
              <div className="table-bordered rounded-md ti-custom-table-head">
                    ...
                    <tbody className="">
                      <tr>
                        <td className="py-3 ltr:pl-4 rtl:pr-4">
                          <div className="flex items-center h-5 justify-center">
                            <input
                              id="hs-table-search-checkbox-11"
                              type="checkbox"
                              className="ti-form-checkbox"
                            />
                            <label
                              htmlFor="hs-table-search-checkbox-11"
                              className="sr-only"
                            >
                              Checkbox
                            </label>
                      ...
                      <tr>
                        <td className="py-3 ltr:pl-4 rtl:pr-4">
                          <div className="flex items-center h-5 justify-center">
                            <input
                              id="hs-table-search-checkbox-12"
                              type="checkbox"
                              className="ti-form-checkbox"
                            />
                            <label
                              htmlFor="hs-table-search-checkbox-12"
                              className="sr-only"
                            >
                              Checkbox
                            </label>
                      ...
                      <tr>
                        <td className="py-3 ltr:pl-4 rtl:pr-4">
                          <div className="flex items-center h-5 justify-center">
                            <input
                              id="hs-table-search-checkbox-13"
                              type="checkbox"
                              className="ti-form-checkbox"
                            />
                            <label
                              htmlFor="hs-table-search-checkbox-13"
                              className="sr-only"
                            >
                              Checkbox
                            </label>
                      ...
                      <tr>
                        <td className="py-3 ltr:pl-4 rtl:pr-4">
                          <div className="flex items-center h-5 justify-center">
                            <input
                              id="hs-table-search-checkbox-14"
                              type="checkbox"
                              className="ti-form-checkbox"
                            />
                            <label
                              htmlFor="hs-table-search-checkbox-14"
                              className="sr-only"
                            >
                              Checkbox
                            </label>
                      ...
                      <tr>
                        <td className="py-3 ltr:pl-4 rtl:pr-4">
                          <div className="flex items-center h-5 justify-center">
                            <input
                              id="hs-table-search-checkbox-15"
                              type="checkbox"
                              className="ti-form-checkbox"
                            />
                            <label
                              htmlFor="hs-table-search-checkbox-15"
                              className="sr-only"
                            >
                              Checkbox
                            </label>
                ...
                <div className="py-1 px-4">
                  <nav className="flex items-center space-x-0 rtl:space-x-reverse">
                    <Link
                      className="text-gray-400 dark:text-white/70 hover:text-primary p-4 inline-flex items-center gap-2 font-medium rounded-md"
                      to="#"
                    >
                    ...
                    <Link
                      className="w-10 h-10 text-gray-400 dark:text-white/70 hover:text-primary p-4 inline-flex items-center text-sm font-medium rounded-full"
                      to="#"
                    >
                      2
                    </Link>
                ...
                <table className="ti-custom-table ti-custom-table-head ti-head-primary">
                  <thead className="">
                    <tr className="!divide-primary/10 dark:!divide-primary/10 ">
                      <th
                        scope="col"
                        className="!text-gray-800  dark:!text-white/70"
                      >
                        Name
                      </th>
                      <th
                      ...
                      <th
                        scope="col"
                        className="!text-end !text-gray-800  dark:!text-white/70"
                      >
                        Action
                      </th>
                    </tr>
                ...
                <table className="ti-custom-table ti-custom-table-head ti-head-info">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>New York No. 1 Lake Park</td>
                      <td className="text-end font-medium">
                        <Link className="text-info hover:text-info" to="#">
                          Delete
                        </Link>
                      </td>
                    </tr>
                ...
                <table className="ti-custom-table ti-custom-table-head ti-head-danger">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>New York No. 1 Lake Park</td>
                      <td className="text-end font-medium">
                        <Link className="text-danger hover:text-danger" to="#">
                          Delete
                        </Link>
                      </td>
                    </tr>
