      ...
      <div className="grid grid-cols-12 gap-x-6">
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown">
                ...
                >
                  Actions
                  <svg
                    className="hs-dropdown-open:rotate-180 ti-dropdown-caret"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown [--trigger:hover]">
                ...
                <div
                  className="hs-dropdown-menu ti-dropdown-menu ti-dropdown-menu-hover"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown">
                ...
                <div
                  className="hs-dropdown-menu hidden ti-dropdown-menu divide-y divide-gray-200"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown">
                ...
                <div
                  className="hs-dropdown-menu ti-dropdown-menu divide-y divide-gray-200"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown">
                ...
                <div
                  className="hs-dropdown-menu ti-dropdown-menu transition-none divide-y divide-gray-200"
                  aria-labelledby="hs-dropdown-with-title"
                >
                  <div className="ti-dropdown-divider">
                    <span className="ti-dropdown-title">Settings</span>
                    <Link className="ti-dropdown-item" to="#">
                      <svg
                        className="flex-none"
                        width="16"
                  ...
                  <div className="ti-dropdown-divider">
                    <span className="ti-dropdown-title">Contacts</span>
                    <Link className="ti-dropdown-item" to="#">
                      <svg
                        className="flex-none"
                        width="16"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown">
                ...
                >
                  <img
                    className="ti-dropdowm-profileimg"
                    src={ALLImages("jpg57")}
                    alt="Maria"
                  />
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown">
                ...
                <div
                  className="hs-dropdown-menu duration-300 ti-dropdown-menu"
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown">
                ...
                <div className="hs-dropdown-menu hidden z-10">
                  <div
                    className="hs-dropdown-open:ease-in hs-dropdown-open:opacity-100 hs-dropdown-open:scale-100 transition ease-out scale-95 duration-200 origin-top-left ti-dropdown-menu block"
          ...
          <div className="box">
            ...
            <div className="box-body">
              ...
              >
                ...
                <div
                  className="hs-dropdown-menu ti-dropdown-menu transition-none"
                ...
                >
                  <div className="relative flex items-start py-2 px-3 rounded-md hover:bg-gray-100 dark:hover:bg-black/20">
                    ...
                    >
                      ...
                      <span
                        ...
                        className="block text-sm text-gray-600 dark:text-white/70"
                      >
                  ...
                  <div className="relative flex items-start py-2 px-3 rounded-md hover:bg-gray-100 dark:hover:bg-black/20">
                    ...
                    <label
                      htmlFor="hs-dropdown-item-checkbox-archive1"
                      className="ltr:ml-3.5 rtl:mr-3.5"
                    >
                      <span className="block text-sm font-semibold text-gray-800 dark:text-white">
                        Archive
          ...
          <div className="box">
            ...
            <div className="box-body">
              ...
              >
                ...
                <div
                  className="hs-dropdown-menu transition-none ti-dropdown-menu"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown [--placement:bottom-left] m-1">
                ...
                <div
                  className="hs-dropdown-menu mt-0 transition-none ti-dropdown-menu"
              ...
              <div className="ti-dropdown m-1">
                <button
                  type="button"
                  className="relative ltr:rounded-l-md rtl:rounded-r-md focus:z-10 ti-dropdown-toggle rounded-none"
                >
                  Split dropdown
                </button>
                <div className="hs-dropdown ti-dropdown [--placement:bottom-left]">
                  <button
                    ...
                    type="button"
                    className="hs-dropdown-toggle relative ltr:-ml-[.3125rem] rtl:-mr-[.3125rem] h-[2.875rem] w-[2.875rem] ltr:rounded-r-md rtl:rounded-l-md focus:z-10 ti-dropdown-toggle rounded-none"
                  >
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown [--placement:left-top] m-1">
                ...
                >
                  Dropleft
                  <svg
                    className="w-auto h-2.5 text-gray-600"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
              ...
              <div className="ti-dropdown m-1">
                <button
                  type="button"
                  className="relative ti-dropdown-toggle rounded-none ltr:rounded-l-md rtl:rounded-r-md focus:z-10"
                >
                  Split dropleft
                </button>
                <div className="hs-dropdown ti-dropdown [--placement:left-top]">
                  <button
                    ...
                    type="button"
                    className="hs-dropdown-toggle relative ltr:-ml-[.3125rem] rtl:-mr-[.3125rem] ti-dropdown-toggle rounded-none h-[2.875rem] w-[2.875rem] ltr:rounded-r-md rtl:rounded-l-md focus:z-10"
                  >
                    <span className="sr-only">Toggle Dropdown</span>
                    <svg
                      className="w-auto h-2.5 ti-dropdown-caret"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                      fill="none"
            ...
            <div className="box-body">
              ...
              <div className="ti-dropdown m-1">
                ...
                <div className="hs-dropdown ti-dropdown [--placement:top-left]">
                  ...
                  <div
                    className="hs-dropdown-menu transition-none mt-0 ti-dropdown-menu"
        ...
        <div className="col-span-12 xl:col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <div
                className="hs-dropdown ti-dropdown m-1"
                data-hs-dropdown-auto-close="inside"
              >
                <button
                ...
                >
                  <div className="relative flex items-start py-2 px-3 rounded-md hover:bg-gray-100 dark:hover:bg-black/20">
                    ...
                    <label
                      htmlFor="hs-dropdown-item-checkbox-delete1"
                      className="ltr:ml-3.5 rtl:mr-3.5"
                    >
                      <span className="mt-1 block text-sm font-semibold text-gray-800 dark:text-white">
                        Delete
                      </span>
                    </label>
                  </div>
            ...
            <div className="box-body">
              ...
              >
                ...
                >
                  ...
                  <svg
                    className="hs-dropdown-open:rotate-180 w-6 h-2.5 text-gray-600"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
                ...
                <div
                  className="hs-dropdown-menu ti-dropdown-menu transition-none top-0 min-w-[16.5rem]"
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown">
                ...
                >
                  Actions
                  <svg
                    className="fill-white text-white hs-dropdown-open:rotate-180 ti-dropdown-caret"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
            ...
            <div className="box-body">
              <div className="hs-dropdown ti-dropdown">
                <button
                  ...
                  type="button"
                  className="hs-dropdown-toggle ti-btn p-0 flex-shrink-0 h-[2.375rem] w-[2.375rem] ti-btn-primary"
                >
                  <svg
                    className="fill-white ti-dropdown-icon"
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                    fill="currentColor"
              ...
              <div className="hs-dropdown ti-dropdown">
                <button
                  ...
                  type="button"
                  className="hs-dropdown-toggle ti-btn p-0 flex-shrink-0 h-[2.875rem] w-[2.875rem] ti-btn-primary"
                >
                  <svg
                    className="fill-white ti-dropdown-icon"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="hs-dropdown ti-dropdown">
                <button
                  ...
                  type="button"
                  className="hs-dropdown-toggle ti-btn p-0 flex-shrink-0 h-[3.875rem] w-[3.875rem] ti-btn-primary"
                >
                  <svg
                    className="fill-white ti-dropdown-icon"
                    xmlns="http://www.w3.org/2000/svg"
