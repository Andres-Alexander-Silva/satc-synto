...
const TooltipPopover = () => {
  return (
    <div>
      <PageHeader
        currentpage="Tooltip & Popovers"
        activepage="Basic Ui"
        mainpage="Tooltip & Popovers"
      />
              ...
              <div className="flex justify-center gap-4">
                <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:left]">
                  ...
                  >
                    ...
                    <div
                      className="hs-tooltip-content ti-main-tooltip-content"
                      role="tooltip"
                    >
                      Left popover
                    </div>
              ...
              <div className="flex justify-center">
                <div className="hs-tooltip ti-main-tooltip [--trigger:click]">
                  ...
                  >
                    ...
                    <div
                      className="hs-tooltip-content ti-main-tooltip-content hidden p-0 max-w-xs border-gray-200 text-start rounded-lg"
                      role="tooltip"
                    >
              ...
              <div className="grid grid-cols-3 gap-y-4 gap-x-2 max-w-[15rem] mx-auto">
                <div className="col-start-2 text-center">
                  <div className="hs-tooltip ti-main-tooltip">
                    <button
                      type="button"
                      className="hs-tooltip-toggle w-10 h-10 ti-btn rounded-full p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white"
                    >
                      <svg
                        className="w-2.5 h-2.5"
                        width="16"
