          ...
          <div className="box">
            ...
            <div className="box-body">
              ...
              <div
                ...
                className="hs-overlay hidden ti-offcanvas ti-offcanvas-left"
                tabIndex={-1}
              >
                <div className="ti-offcanvas-header">
                  <h3 className="ti-offcanvas-title">Notifications</h3>
                  <button
                    type="button"
                    className="ti-btn flex-shrink-0 h-8 w-8 p-0 transition-none text-gray-500 hover:text-gray-700 focus:ring-gray-400 focus:ring-offset-white dark:text-white/70 dark:hover:text-white/80 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
                    data-hs-overlay="#hs-overlay-example"
                  >
                      ...
                      <div className="flex items-center w-full">
                        ...
                        <div className="flex-auto">
                          <p className="font-semibold mb-0">
                            New Website Created
                            <span className="badge bg-gray-100 text-gray-500 dark:text-white/70 dark:bg-black/20 ltr:float-right rtl:float-left px-2 py-1 leading-none text-[10px]">
                              20 Nov 2022
                            </span>
                          </p>
                          <span className="text-xs text-gray-500 dark:text-white/70">
                            <i className="ri-time-line align-middle ltr:mr-1 rtl:ml-1"></i>
                            30 mins ago
                          </span>
                        </div>
                      </div>
        ...
        <div className="col-span-12 lg:col-span-9">
          <div className="box">
            ...
            <div className="box-body">
              ...
              <div
                id="hs-overlay-top"
                className="hs-overlay hidden ti-offcanvas ti-offcanvas-top"
                tabIndex={-1}
              >
                <div className="ti-offcanvas-header">
                  <h3 className="ti-offcanvas-title">Offcanvas title</h3>
                  <button
                    type="button"
                    className="ti-btn flex-shrink-0 h-8 w-8 p-0 transition-none text-gray-500 hover:text-gray-700 focus:ring-gray-400 focus:ring-offset-white dark:text-white/70 dark:hover:text-white/80 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
                    data-hs-overlay="#hs-overlay-top"
              ...
              <div
                ...
                className="hs-overlay hidden ti-offcanvas ti-offcanvas-bottom"
                tabIndex={-1}
              >
                <div className="ti-offcanvas-header">
                  <h3 className="ti-offcanvas-title">Offcanvas title</h3>
        ...
        <div className="col-span-12">
          <div className="box">
            ...
            <div className="box-body">
              <button
                type="button"
                className="m-1 ltr:ml-0 rtl:mr-0 ti-btn ti-btn-primary"
              ...
              <div
                ...
                className="hs-overlay ti-offcanvas ti-offcanvas-left hidden [--body-scroll:true] [--overlay-backdrop:false]"
                tabIndex={-1}
              >
                <div className="ti-offcanvas-header">
                  <h3 className="ti-offcanvas-title">Notifications</h3>
              ...
              <div
                ...
                className="hs-overlay ti-offcanvas ti-offcanvas-left hidden"
                tabIndex={-1}
              >
                <div className="ti-offcanvas-header">
                  <h3 className="ti-offcanvas-title">Notifications</h3>
