                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="flex rounded-sm overflow-auto">
                                ...
                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10" showIcon selected={startDate} onChange={(date: Date) => setStartDate(date)} />
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="flex rounded-sm overflow-auto">
                                ...
                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10" selected={startDate} onChange={(date: Date) => setStartDate(date)} timeInputLabel="Time:" dateFormat="MM/dd/yyyy h:mm aa" showTimeInput />
                    ...
                    <div className="box">
                        ...
                        <div className="box-body date-picker">
                            <div className="flex rounded-sm overflow-auto">
                                ...
                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10" selected={startDate} onChange={(date: Date) => setStartDate(date)} locale="en-GB" showTimeSelect timeFormat="p" timeIntervals={15} dateFormat="Pp" />
            ...
            <div className="grid grid-cols-12 gap-x-6">
                ...
                <div className="col-span-12 lg:col-span-3">
                    <div className="box">
                        ...
                        <div className="box-body date-picker specific-timepicker">
                            <div className="flex rounded-sm">
                                ...
                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10" selected={startTime} onChange={(date: Date) => setStartTime(date)} showTimeSelect minTime={setHours(setMinutes(new Date(), 0), 17)} maxTime={setHours(setMinutes(new Date(), 30), 20)} dateFormat="MMMM d, yyyy h:mm aa" />
                    ...
                    <div className="box multiple-month-picker">
                        ...
                        <div className="box-body">
                            <div className="flex rounded-sm overflow-auto">
                                ...
                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10 flatpickr-input" selected={startDate} onChange={(date: Date) => setStartDate(date)} monthsShown={2} />
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="flex rounded-sm overflow-auto">
                                ...
                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10" selected={startDate} onChange={(date: Date) => setStartDate(date)} showTimeSelect showTimeSelectOnly timeIntervals={15} timeCaption="Time" dateFormat="h:mm aa" />
                    ...
                    <div className="box">
                        ...
                        <div className="box-body date-picker">
                            <div className="flex rounded-sm overflow-auto">
                                ...
                                <DatePicker className="ti-form-input rounded-none ltr:border-r-0 rtl:border-l-0 focus:z-10 flatpickr-input" selected={startDate} onChange={(date: Date) => setStartDate(date)} dateFormat="MM/yyyy" showMonthYearPicker showFullMonthYearPicker />
                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10 flatpickr-input" selected={startDate} onChange={(date: Date) => setStartDate(date)} showYearPicker dateFormat="yyyy" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="flex rounded-sm overflow-auto">
                                ...
                                <DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10 flatpickr-input" selected={startDate} onChange={(date: Date) => setStartDate(date)} minDate={new Date()} maxDate={addDays(new Date(), 5)} placeholderText="Select a date between today and 5 days in the future" />
