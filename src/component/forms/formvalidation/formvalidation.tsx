                                ...
                                <form className = "ti-validation">
                                    <div className = "grid lg:grid-cols-2 gap-6">
                                        ...
                                        <div className = "space-y-2 date-of-birth">
                                            ...
                                            <DatePicker className = "ti-form-input" showIcon selected={startDate} onChange={(date: Date) => setStartDate(date)} />
                                        </div>
                                        <div className = "space-y-2">
                            ...
                            <div className = "box-body">
                                <form className = "ti-custom-validation" noValidate>
                                    <div className = "grid lg:grid-cols-2 gap-6">
                                        ...
                                        <div className = "space-y-2">
                                            <label className = "ti-form-label mb-0">Date Of Birth</label>
                                            <DatePicker className = "birthdate ti-form-input" showIcon selected={startDate} onChange={(date: Date) => setStartDate(date)} />
