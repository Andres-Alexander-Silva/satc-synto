      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            ...
            <div className="box-body  multiple-select">
              ...
              <MultiSelect className='react-select' options={Multiselectcomponent} value={selected} onChange={setSelected} labelledBy="Select" />
              <label className="ti-form-select-label mt-2">MultiSelect Disabled</label>
              <MultiSelect  options={Multiselectcomponent}  onChange={setSelected} disabled labelledBy="Select" value={[]} />
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            ...
            <div className="box-body">
              <label className="ti-form-select-label mt-2">Creatable Single  with multi Select</label>
              <CreatableSelect components={components} classNamePrefix='react-select' inputValue={inputValue} isClearable isMulti menuIsOpen={false} onChange={(newValue: React.SetStateAction<never[]>) => setValue(newValue)} onInputChange={(newValue: React.SetStateAction<never[]>) => setInputValue(newValue)} onKeyDown={handleKeyDown} placeholder="Type something and press enter..." value={value} />
