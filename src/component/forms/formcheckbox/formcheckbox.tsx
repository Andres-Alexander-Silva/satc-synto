    ...
    <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex opacity-40">
                  <input
                    type="checkbox"
                    className="ti-form-checkbox mt-0.5"
                    id="hs-disabled-checked-checkbox"
                    checked
                    disabled
                  />
                  <label
                    htmlFor="hs-disabled-checked-checkbox"
                    className="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70"
                  >
      ...
      <div className="grid grid-cols-12 gap-x-6">
            ...
            <div className="box-body">
              <div className="grid sm:grid-cols-2 gap-2">
                <label className="p-3 flex w-full bg-white border border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70">
                  ...
                  />
                  <span className="text-sm text-gray-500 ltr:ml-2 rtl:mr-2 dark:text-white/70">
                    Default checkbox
                  </span>
                </label>
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Checkbox With List Group On Right</h5>
            </div>
            <div className="box-body">
              <div className="grid sm:grid-cols-2 gap-2">
                <label className="flex p-3 w-full bg-white border border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70">
                  ...
                  <input
                    type="checkbox"
                    className="ti-form-checkbox ltr:ml-auto rtl:mr-auto mt-0.5 pointer-events-none"
                    id="hs-checkbox-on-right"
                  />
                </label>
                ...
                <label className="flex p-3 w-full bg-white border border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70">
                  ...
                  <input
                    type="checkbox"
                    className="ti-form-checkbox ltr:ml-auto rtl:mr-auto mt-0.5 pointer-events-none"
                    id="hs-checkbox-checkbox-on-right"
                    defaultChecked
                  />
                </label>
              </div>
              ...
              <div className="grid space-y-3">
                ...
                <div className="relative flex items-start">
                  ...
                  >
                    ...
                    <span
                      id="hs-checkbox-archive-description"
                      className="block text-sm text-gray-600 dark:text-white/70"
                    >
                      Notify me when this action happens.
                    </span>
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Checkbox With List Group</h5>
            </div>
            <div className="box-body">
                ...
                <li className="ti-list-group bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white">
                  <div className="relative flex items-start w-full">
                    ...
                    <label
                      ...
                      className="ltr:ml-2.5 rtl:mr-2.5 block w-full text-sm text-gray-600 dark:text-white/70"
                    >
                      Chris Lynch
                    </label>
                  </div>
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Checkbox With Horizontal List Group</h5>
            </div>
            <div className="box-body">
