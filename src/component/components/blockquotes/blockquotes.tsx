						...
						<div className="box-body">
							<blockquote className="relative">
								...
								<footer className="mt-6">
									<div className="text-base font-semibold text-gray-800 dark:text-white/10">Josh Grazioso</div>
								</footer>
							</blockquote>
						</div>
					</div>
								...
								<footer className="mt-6">
									<div className="flex items-center">
										...
										<div className="ltr:ml-4 rtl:mr-4">
											<div className="text-base font-semibold text-gray-800 dark:text-white/10">Josh Grazioso</div>
											<div className="text-xs text-gray-500 dark:text-white/10">Source title</div>
										</div>
									</div>
								</footer>
							</blockquote>
