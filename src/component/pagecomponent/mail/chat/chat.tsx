...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    if (detailsRef.current) {
      if (isDetailsOpen) {
        detailsRef.current.addEventListener('click', handleDetailsClick);
      } else {
        detailsRef.current.removeEventListener('click', handleDetailsClick);
      }
    }
  }, [isDetailsOpen]);
	...
	return (
		<div >
			...
			<div className="main-chart-wrapper px-5 gap-2 lg:flex">
								...
								<div className="flex items-center space-x-4 rtl:space-x-reverse">
									...
									<div>
										<p className="text-base">
											<Link to="#" className="chatnameperson responsive-userinfo-open" onClick={handleLinkClick}>Airi Satou</Link>
										</p>
				...
				<div ref={detailsRef} className={`chat-user-details ${isDetailsOpen ? 'open' : ''}`} id="chat-user-details">
					<div className="box">
