...
import { To_do_List_Data, todolistType } from "../../../common/commondata";

const Todolist = () => {
	const [startDate, setStartDate] = useState<Date>(new Date());

	const [allData, setAllData] = useState<todolistType[]>(To_do_List_Data)

	let allElement2: todolistType[] = [];
												...
												<div className="space-y-3">
													...
													<div>
														...
														<div className="flex rounded-sm shadow-sm">
															...
															<DatePicker className="ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10 flatpickr-input" showIcon selected={startDate} onChange={(date: Date) => setStartDate(date)} />
														</div>
													</div>
													<div>
