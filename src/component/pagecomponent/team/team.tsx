...
import { TeammemberData, TeammemberData1, TeammemberDataType } from "../../../common/commondata";

const Team = () => {

	const [allData, setAllData] = useState<TeammemberDataType[]>(TeammemberData)
	const [allData1, _setAllData1] = useState<TeammemberDataType[]>(TeammemberData1)
	
	let allElement2: TeammemberDataType[] = [];
