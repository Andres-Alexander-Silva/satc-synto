...
const Profilesetting = () => {
	...
	const [selected, setSelected] = useState(['Laravel', 'Angular', 'Html', 'VueJs', 'React' ]);  // react-tag-input-component
			...
			const [ClassName, _setClassName] = useState()
										...
										<div>
											<div className= "grid lg:grid-cols-2 gap-6">
												...
												<div className= "space-y-2">
													...
													<DatePicker className="ti-form-input rounded-l-none focus:z-10" showIcon selected={startDate} onChange={(date: Date) => setStartDate(date)} placeholderText='choose Date' />
												</div>
												<div className= "space-y-2">
                                        ...
                                        Others
											...
											<div className= "mt-5">
												<div className= "space-y-2">
													...
													<textarea className= "ti-form-input" rows={3} placeholder="Add Your Bio"/>
												</div>
											</div>
										</div>
									</div>
									...
									<div className= "box-body">
										...
										<div className= "my-4">
											...
											<div className= "space-y-2" id="skills">
												...
												<TagsInput value={selected} onChange={setSelected} name="ProductTag" placeHolder="Filter product" />
											</div>
										</div>
								...
								<div className= "box border-0 shadow-none mb-0">
									...
									<div className= "box-body">
										<div className= "space-y-4">
											...
											<div className= "p-4 border border-gray-200 dark:border-white/10 rounded-sm">
												<div className= "md:grid grid-cols-12 gap-6 space-y-4 mb-6 sm:mb-0">
													<div className= "col-span-12 md:col-span-6 my-auto">
													...
													<div className= "col-span-12 md:col-span-6">
														<div className= "space-y-2">
															<div className= "sm:grid grid-cols-12 gap-6 space-y-1 md:text-end">
																<div className= "col-span-9 my-auto">
																	<label className= "text-sm text-gray-500 ltr:ml-3 rtl:mr-3 dark:text-white/70">Notify Me</label>
																</div>
																<div className= "col-span-3 my-auto">
