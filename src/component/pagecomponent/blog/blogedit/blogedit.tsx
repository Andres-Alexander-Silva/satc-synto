...
const Blogedit = () => {
	...
	const [files, setFiles] = useState<any>([]);  //file pond 
				...
				<div className="col-span-12 xxl:col-span-9">
					<div className="box">
						<div className="box-body space-y-5">
							...
							<div className="blog-edit-categories">
							...
							<div>
								...
								<SunEditor name='ht-250' height="260" />
							</div>
							<div>
							...
							<div className="sm:grid grid-cols-12 sm:gap-6 space-y-5 sm:space-y-0">
								...
								<div className="col-span-12 lg:col-span-4 blog-input">
									...
									<div className="flex rounded-sm">
										...
										<DatePicker className="ltr:rounded-l-none rtl:rounded-r-none focus:z-10 flatpickr-input w-[320px]" showIcon selected={startDate} onChange={(date: Date) => setStartDate(date)} />
									</div>
								</div>
								<div className="col-span-12 lg:col-span-4 blog-input">
								...
								<div className="col-span-12 lg:col-span-4 blog-input">
									...
									<Select className="blog-tag3" options={PlubishStatus} placeholder='Status' values={[]} onChange={(value) => console.log(value)} />
								</div>
							</div>
						</div>
										...
										<div className="my-auto ltr:ml-auto rtl:mr-auto hidden sm:block">
											<button type="button" aria-label="button"
												className="m-0 p-2 ti-btn bg-gray-100 text-gray-500 hover:text-white hover:bg-gray-500 ring-offset-white focus:ring-gray-500 dark:bg-black/20 dark:hover:bg-black/30 dark:focus:ring-gray-600 dark:text-white dark:focus:ring-offset-white/10"><i
													className="leading-none ri-arrow-right-s-line rtl:rotate-0"></i></button>
										</div>
									</div>
								</div>
							</li>
