...
const Addproduct = () => {
	...
	const [startDate, setStartDate] = useState<Date>(new Date()); //Data picker
										...
										<div className="box-body">
											<div className="space-y-3">
												...
												<div className="space-y-2">
													...
													<textarea className="ti-form-input" rows={2}/>
													<label
												...
												<div className="col-span-12 lg:col-span-6">
													<div className="space-y-2  product-1">
														...
														<div className="flex rounded-sm shadow-sm">
															...
															<DatePicker className="ti-form-input published-datepicker rounded-l-none focus:z-10" selected={startDate} onChange={(date: Date) => setStartDate(date)} locale="en-GB" showTimeSelect timeFormat="p" timeIntervals={15} dateFormat="Pp" />
														</div>
													</div>
												</div>
												<div className="col-span-12 lg:col-span-6">
