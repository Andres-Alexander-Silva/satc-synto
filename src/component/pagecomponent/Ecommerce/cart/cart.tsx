								...
								<table className= "ti-custom-table ti-custom-table-head">
									<thead className= "">
										<tr>
											...
											<th scope="col" className= "!text-sm !p-4 !text-gray-800 dark:!text-white">Quantity</th>
											...
											<td className= "text-end font-medium">
												<div className= "hs-tooltip ti-main-tooltip">
													<Link to={`${import.meta.env.BASE_URL}pagecomponent/Ecommerce/wishlist/`} className= "hs-tooltip-toggle w-10 h-10 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary">
														...
														<span className= "hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm dark:bg-slate-700" role="tooltip"> Save To Wishlist</span>
													</Link>
												</div>
												<div className= "hs-tooltip ti-main-tooltip">
