											...
											<div className="flex flex-col md:flex-row space-y-6 justify-between mb-5">
												<div className="space-y-2">
													<div className="mb-2">
														...
														<img src={ALLImages('desktop-light')} alt="logo" className="hidden dark:flex" />
													</div>
							...
							<div className="xl:flex xl:justify-between space-y-3 xl:space-y-0">
								...
								<div className="sm:space-x-3 sm:flex space-y-3 sm:space-y-0 rtl:space-x-reverse">
									<div className="inline-flex">
										...
										<DatePicker className="px-3 py-2 ti-form-input ltr:rounded-l-none rtl:rounded-r-none focus:z-10 flatpickr-input" showIcon selected={startDate} onChange={(date: Date) => setStartDate(date)} />
									</div>
