...
const Widgets = ({ThemeChanger}: datatype) => {
	useEffect(() => {
							...
							<div className= "flex flex-wrap justify-between">
								<div className= "flex-auto">
									...
									<div className= "flex items-center">
										...
										<span className= "text-xs text-success ltr:ml-2 rtl:mr-2"><i className= "ti ti-trending-up ltr:mr-1 rtl:ml-1 inline-flex"></i>0.5%</span>
									</div>
								</div>
								<div>
							...
							<div className= "flex flex-wrap justify-between">
								<div className= "flex-auto">
									...
									<div className= "flex items-center">
										...
										<span className= "text-xs text-success ltr:ml-2 rtl:mr-2"><i className= "ti ti-trending-up ltr:mr-1 rtl:ml-1 inline-flex"></i>0.42%</span>
									</div>
								</div>
								<div>
							...
							<div className= "flex flex-wrap  justify-between">
								<div className= "flex-auto">
									...
									<div className= "flex items-center">
										...
										<span className= "text-xs text-success ltr:ml-2 rtl:mr-2"><i className= "ti ti-trending-up ltr:mr-1 rtl:ml-1 inline-flex"></i>5.1%</span>
									</div>
								</div>
								<div>
							...
							<div className= "flex flex-wrap justify-between">
								<div className= "flex-auto">
									...
									<div className= "flex items-center">
										...
										<span className= "text-xs text-success ltr:ml-2 rtl:mr-2"><i className= "ti ti-trending-up inline-flex ltr:mr-1 rtl:ml-1"></i>3.5%</span>
									</div>
								</div>
								<div>
						...
						<div className= "col-span-12 sm:col-span-6">
							<div className= "box">
								<div className= "box-body">
									...
									<span className= "text-xl font-semibold text-gray-800 dark:text-white">9,231</span>
									<span className= "text-xs text-success ltr:ml-1 rtl:mr-1"><i className= "ti ti-trending-up inline-flex ltr:mr-1 rtl:ml-1"></i>0.5%</span>
								</div>
							</div>
						</div>
						<div className= "col-span-12 sm:col-span-6">
							<div className= "box !bg-primary text-white">
								<div className= "box-body">
									...
									<span className= "text-xs opacity-70 ltr:ml-1 rtl:mr-1"><i className= "ti ti-trending-up inline-flex ltr:mr-1 rtl:ml-1"></i>0.5%</span>
								</div>
							</div>
						</div>
						<div className= "col-span-12 sm:col-span-6">
							<div className= "box overflow-hidden">
								<div className= "box-body p-0">
									<div className= "p-4">
										...
										<span className= "text-xs text-success ltr:ml-1 rtl:mr-1"><i className= "ti ti-trending-up inline-flex ltr:mr-1 rtl:ml-1"></i>3.5%</span>
									</div>
									<WidgetsRevenue/>
								</div>
							</div>
						...
						<div className= "col-span-12 sm:col-span-6">
							<div className= "box">
								<div className= "box-body">
									...
									<span className= "text-xl font-semibold text-gray-800 dark:text-white">$12,897</span>
									<span className= "text-xs text-success"><i className= "ti ti-trending-up inline-flex ltr:mr-1 rtl:ml-1"></i>3.5%</span>
					...
					<div className= "box">
						<div className= "box-body">
							<div className= "flex items-center mb-2">
								...
								<div>
									<Link to="#" className= "ti-btn ti-btn-soft-primary" aria-label="View All"><i className= "ri-arrow-right-s-line rtl:rotate-0"></i></Link>
								</div>
							</div>
				...
				<div className= "xxl:!col-span-2 lg:col-span-6 col-span-12">
					<div className= "box !bg-primary text-white">
						<div className= "box-header flex justify-between border-b-0 bg-white/10">
							...
							<div>
								<button aria-label="button" type="button" className= "ti-btn ti-btn-primary p-2"><i className= "ri-arrow-right-s-line rtl:rotate-0"></i></button>
							</div>
						</div>
						<div className= "box-body">
								...
								<div className= "flex flex-wrap mb-1">
									...
									<div className= "flex-auto">
										<div className= "flex flex-wrap items-center justify-between mb-1 text-sm">
											...
											<span className= "text-success text-end"><i className= "ti ti-trending-up inline-flex text-xs ltr:mr-1 rtl:ml-1 inline-flex"></i>0.14%</span>
										</div>
								...
								<div className= "flex flex-wrap mb-1">
									...
									<div className= "flex-auto">
										<div className= "flex flex-wrap items-center justify-between mb-1 text-sm">
											...
											<span className= "text-success text-end"><i className= "ti ti-trending-up inline-flex text-xs ltr:mr-1 rtl:ml-1 inline-flex"></i>2.14%</span>
										</div>
										<div className= "flex flex-wrap items-center justify-between text-xs mb-3">
					...
					<div className= "box">
						<div className= "box-body">
							...
							<div className= "flex items-center mb-0">
								...
								<span className= "text-gray-500 dark:text-white/70 ltr:ml-2 rtl:mr-2"><i className= "ti ti-trending-up inline-flex align-middle text-success ltr:mr-1 rtl:ml-1"></i>2.5%</span>
							</div>
							<div className= "flex items-center">
								<div className= "flex-auto">
					...
					<div className= "box">
						<div className= "box-body">
							...
							<div className= "flex items-center mb-0">
								...
								<span className= "text-gray-500 dark:text-white/70 ltr:ml-2 rtl:mr-2"><i className= "ti ti-trending-up inline-flex align-middle text-success ltr:mr-1 rtl:ml-1"></i>3.1%</span>
							</div>
							<div className= "flex items-center">
								<div className= "flex-auto">
									<div className= "ti-main-progress bg-gray-200 dark:bg-black/20">
					...
					<div className= "box">
						<div className= "box-body">
							...
							<div className= "flex items-center mb-0">
								...
								<span className= "text-gray-500 dark:text-white/70 ltr:ml-2 rtl:mr-2"><i className= "ti ti-trending-up inline-flex align-middle text-success ltr:mr-1 rtl:ml-1"></i>5.4%</span>
							</div>
							<div className= "flex items-center">
								<div className= "flex-auto">
									<div className= "ti-main-progress bg-gray-200 dark:bg-black/20">
