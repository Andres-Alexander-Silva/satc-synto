			...
			<div className="grid grid-cols-12 gap-x-6">
				...
				<div className="col-span-12 lg:col-span-4">
					<div className="box">
						...
						<div className="box-body">
							<div className="w-10/12 sm:w-8/12 mx-auto">
								<Swiper zoom={true} navigation={true} pagination={{ clickable: true }} modules={[Zoom, Navigation, Pagination]} className="mySwiper13" >
				...
				<div className="col-span-12 lg:col-span-4">
					<div className="box">
						...
						<div className="box-body">
							<div className="w-10/12 sm:w-8/12 mx-auto">
								<Swiper spaceBetween={30} effect={"fade"} navigation={true} pagination={{ clickable: true, }} modules={[EffectFade, Navigation, Pagination]} className="mySwiper8">
									<SwiperSlide><img src={ALLImages('jpg10')} alt="image" /></SwiperSlide>
									<SwiperSlide><img src={ALLImages('jpg11')} alt="image" /></SwiperSlide>
									<SwiperSlide><img src={ALLImages('jpg12')} alt="image" /></SwiperSlide>
									<SwiperSlide><img src={ALLImages('jpg13')} alt="image" /></SwiperSlide>
