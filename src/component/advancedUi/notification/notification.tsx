...
import toast, { ToasterProps, Toaster } from 'react-hot-toast';
			...
			<div className="grid grid-cols-12 gap-x-5">
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body text-center">
							<button type="button" className="ti-btn ti-btn-danger" id="error" onClick={() => ErrorNotify()}>Error Notification</button>
						</div>
					</div>
				</div>
