...
import { Filemanagerlistdata, filemanagertype } from "../filemanagermain/reactfiledata";
const Filemanagerlist = () => {
	const [allData, setAllData] = useState<filemanagertype[]>(Filemanagerlistdata)

	let allElement2: filemanagertype[] = [];
